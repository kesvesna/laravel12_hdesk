document.addEventListener('DOMContentLoaded', function() {
    ...
    let onchange_equipment_function = function() {
        ...
        $(this).closest('tr').find('.estimated_coefficient').attr('name', 'equipments[' + equipment_id + '][estimated_coefficient]');
        $(this).closest('tr').find('.air_speed').attr('name', 'equipments[' + equipment_id + '][air_speed]');
        $(this).closest('tr').find('.diffuser_cross_sectional_area').attr('name', 'equipments[' + equipment_id + '][diffuser_cross_sectional_area]');
