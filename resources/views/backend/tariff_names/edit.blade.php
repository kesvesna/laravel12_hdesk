...
@section('title', 'Главная | Тариф редактирование')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Тариф редактирование</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('tariff_names.update', $tariff_name)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
                                ...
                                <div class="card shadow">
                                    <div class="input-group mt-3 px-3">
                                        ...
                                        <input value="{{$tariff_name->name}}" name="name" type="text"
                                    ...
                                    <div class="input-group my-3 px-3">
                                        ...
                                        <input value="{{$tariff_name->alias}}" name="alias" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$tariff_name->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$tariff_name->author->name}}" name="author_id" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$tariff_name->updated_at}}" name="updated_at" type="text"
