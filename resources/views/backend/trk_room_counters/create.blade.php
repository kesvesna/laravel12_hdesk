        ...
        <div class="container-fluid">
            ...
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="{{route('trk_room_counters.store')}}" method="post">
                                @csrf
                                <div class="card shadow p-3">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select required name="trk_id" id="trk_id"
                                                ...
                                                @forelse($all_trks as $trk)
                                                    <option
                                                        value="{{$trk->id}}" {{$show_user_trk == true && $trk->id == $user_trk ? 'selected' : null}}>{{$trk->name}}</option>
                                                @empty
                                    ...
                                    <div class="row">
                                        <div class="col mb-4">
                                            ...
                                            <input required class="form-control form-control-sm"
                                                   type="text" id="number" placeholder="Номер счетчика" name="number">
                                            @error('number')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col mb-4">
                                            ...
                                            <input class="form-control form-control-sm" type="date" id="mounted_at"
                                                   placeholder="Поиск ..." name="mounted_at"
                                    ...
                                    <div class="row">
                                        <div class="col mb-4">
                                            <label class="form-label form-label-sm" for="using_purpose">Где используется
                                                (наружная реклама, и т.д.)</label>
                                            <input class="form-control form-control-sm" type="text" id="using_purpose"
                                                   placeholder="Например: Реклама" name="using_purpose"
