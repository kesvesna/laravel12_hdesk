...
@section('title', 'Главная | Обход по QR')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Обход по QR</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('room_checks.store_by_qr')}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <input hidden name="trk_room_id" value="{{$trk_room->id}}">
                                            <label for="trk_id" class="form-label form-label-sm">ТРК</label>
                                            <input disabled class="form-control form-control-sm" id="trk_id"
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            ...
                                            <input disabled class="form-control form-control-sm" id="room_id"
