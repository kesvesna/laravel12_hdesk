...
@section('title', 'Главная | Профиль арендатора')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Профиль арендатора</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="col">
                            ...
                            <div class="p-2">
                                <a href="{{route('renter_profile.edit', Auth::id())}}" class="btn btn-success"><i
