            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Редактирование профиля арендатора</h4>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="nav nav-tabs-custom rounded border-bottom-0" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link pb-3" data-bs-toggle="tab" href="#experience" role="tab">
                                        <i class="far fa-envelope"></i> ТРК/Помещения/Бренд
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content">
                                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                    <form action="{{route('renter_profile.update', Auth::id())}}" method="post">
                                        @csrf
                                        @method('patch')
                                        <div class="row">
                                            <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row row-cols-1 row-cols-md-2">
                                                    ...
                                                    <div class="col">
                                                        <a href="{{route('renter_profile.index')}}" type="button"
                                ...
                                <div class="tab-pane" id="changePassword" role="tabpanel">
                                    <form action="{{route('renter_profile.password_change', Auth::id())}}"
                                          method="post">
                                        @csrf
                                        @method('patch')
                                        <div class="row g-2">
                                ...
                                <div class="tab-pane" id="experience" role="tabpanel">
                                    <form
                                        action="{{route('renter_profile.user_responsibility_trk_system_change', Auth::id())}}"
                                        method="post">
                                        @csrf
                                        @method('patch')
                                        <div class="row">
                                            <div class="col">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            <div class="col pt-1">
                                                                <b>Выберите ТРК/Помещения/Бренд</b>
                                                            </div>
                                                            <div class="col">
                                ...
                                <div class="tab-pane" id="privacy" role="tabpanel">
                                    <form
                                        action="{{route('renter_profile.user_subscription_entity_event_change', Auth::id())}}"
                                        method="post">
                                        @csrf
                                        @method('patch')
                                        <div class="row">
                                ...
                                <div class="tab-pane" id="filters" role="tabpanel">
                                    <form action="{{route('renter_profile.user_filter_trk_system_change', Auth::id())}}"
                                          method="post">
                                        @csrf
                                        @method('patch')
                                        <div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">ТРК/Помещения/Бренд</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Эта информация будет использована</p>
                        <p>для администрации ТРК при подаче заявок от Вас</p>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>происходит с Вашей заявкой</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>
                    </div>
        ...
        <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel3"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Отметьте ТРК/Помещения,</p>
                        <p>которые вы хотите видеть</p>
                        <p>при работе с сайтом.</p>
                        <p>Остальные не будут отображаться</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>
                    </div>
