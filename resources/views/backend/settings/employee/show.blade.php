                ...
                <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="col">
                            ...
                            <div class="p-2">
                                <a href="{{route('employee_profile.edit', $user->id)}}" class="btn btn-success"><i
                                                                ...
                                                                <div class="card-body">
                                                                    <ul class="list-group list-group-flush">
                                                                        <li class="list-group-item">
                                                                            <b>Город:</b> {{$user->town->name ?? 'не заполнено'}}
                                                                        </li>
                                                                        <li class="list-group-item">
                                                                            <b>Организация:</b> {{$user->organization->name ?? 'не заполнено'}}
                                                                        </li>
                                                                        <li class="list-group-item">
                                                                            <b>Подразделение:</b> {{$user->division->name ?? 'не заполнено'}}
                                                                        </li>
                                                                        <li class="list-group-item">
                                                                            <b>Должность:</b> {{$user->function->name ?? 'не заполнено'}}
                                                                        </li>
                                                                        <li class="list-group-item">
                                                                            <b>Телефон:</b> {{$user->phone ?? 'не заполнено'}}
                                                                        </li>
                                                                        <li class="list-group-item">
                                                                            <b>Email:</b> {{$user->email}}</li>
                                                                        <li class="list-group-item">
                                                                            <b>Руководитель:</b> {{$user->superior->name ?? 'не заполнено'}}
                                                                            @if(!empty($user->superior->name))
                                                                                <a href="tel:{{$user->superior->phone}}"
                                                                                   class="ms-2">
                                                                                    <img
                                                                                ...
                                                                                <a href="mailto:{{$user->superior->email}}"
                                                                                   class="ms-2">
                                                                                    <img
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="accordion accordion-flush"
                                                                        ...
                                                                        @if(isset($user->responsibility_trks))
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="accordion accordion-flush"
                                                                        ...
                                                                        @if(isset($user->subscription_entities))
