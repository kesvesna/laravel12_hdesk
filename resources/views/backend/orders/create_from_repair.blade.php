...
@section('title', 'Главная | Заказ создание для ремонта')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Создание заказа для ремонта</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('orders.store_from_repair', $repair)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col mb-3">
                                            ...
                                            <select disabled name="trk_id" class="form-select form-select-sm"
                                                    id="trk_id">
                                                @forelse($trks as $trk)
                                                    <option value="{{$trk->id}}" {{$repair->trk_room->trk->id == $trk->id ? 'selected' : null}}>{{$trk->name}}</option>
                                                @empty
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select disabled name="system_id" class="form-select form-select-sm">
                                                @forelse($systems as $system)
                                                    <option value="{{$system->id}}" {{$repair->trk_equipment->system->id == $system->id ? 'selected' : null}}>{{$system->name}}</option>
                                                @empty
                                                    <option value="">нет данных ...</option>
                                                @endforelse
                                            </select>
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <input readonly type="text" list="room_names_list"
                                                   ...
                                                   name="room_name" data-equipment-id="0" value="{{$repair->trk_room->room->name}}">
