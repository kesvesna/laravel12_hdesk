...
@section('title', 'Главная | Заказ запчасти для оборудования')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Создание заказа для оборудования</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('orders.store_from_trk_equipment', $trk_equipment)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col mb-3">
                                            ...
                                            <select disabled name="trk_id" class="form-select form-select-sm"
                                                    id="trk_id">
                                                @forelse($trks as $trk)
                                                    <option value="{{$trk->id}}" {{$trk_equipment->trk_room->trk->id == $trk->id ? 'selected' : null}}>{{$trk->name}}</option>
                                                @empty
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select disabled name="system_id" class="form-select form-select-sm">
                                                @forelse($systems as $system)
                                                    <option value="{{$system->id}}" {{$trk_equipment->system->id == $system->id ? 'selected' : null}}>{{$system->name}}</option>
                                                @empty
                                                    <option value="">нет данных ...</option>
                                                @endforelse
                                            </select>
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <input readonly type="text" list="room_names_list"
                                                   class="form-control form-control-sm room-name-input"
                                                   placeholder="Начните писать ..."
                                                   name="room_name" data-equipment-id="0" value="{{$trk_equipment->trk_room->room->name}}">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <input readonly type="text" list="equipment_names_list"
                                                   class="form-control form-control-sm equipment-name-input"
                                                   placeholder="Начните писать ..."
                                                   name="equipment_name" data-equipment-id="0" value="{{$trk_equipment->equipment_name->name}}">
                                        ...
                                        <div class="col mb-4">
                                            ...
                                            <div class="spare-parts-add-parent-div p-2 mb-1 rounded"
                                                ...
                                                <label for="basic-url" class="form-label form-label-sm">Запчасть</label>
                                                        ...
                                                        <div class="col-12 col-md-5">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input required type="text" list="spare_parts_list"
                                                                       ...
                                                                       value="{{$equipment_spare_part->part_name->name}}">
                                                        ...
                                                        <div class="col-12 col-md-7 mb-1">
                                                            <div class="input-group input-group-sm mt-1 mt-md-0">
                                                                <input required type="text"
                                                                       ...
                                                                       value="{{$equipment_spare_part->model}}"
