                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item"><b>ТРК: </b>{{$counter->trk->name}}</li>
                                    <li class="list-group-item"><b>№ счетчика: </b>{{$counter->number}}</li>
                                    <li class="list-group-item"><b>Тип: </b>{{$counter->type->name}}</li>
                                    <li class="list-group-item"><b>Тариф: </b>{{$counter->tariff->name}}</li>
                                </ul>
