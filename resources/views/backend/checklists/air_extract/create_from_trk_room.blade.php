...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Заполнение чеклистов вытяжек</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_air_extract.store_from_trk_room', $trk_room)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="row row-cols-1">
                                        ...
                                        @enderror
                                                ...
                                                <td>
                                                    <input required class="form-control form-control-sm extract_air_t" name="equipments[0][extract_air_t]" placeholder="21.0" type="number" step="0.1">
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm extract_engine_t" name="equipments[0][extract_engine_t]" placeholder="50" type="number">
                                                </td>
                                    <td>
                                        <input class="form-control form-control-sm front_bearing_t" name="equipments[0][front_bearing_t]" placeholder="45" type="number">
                                                ...
                                                <td>
                                                    <input class="form-control form-control-sm extract_engine_terminal_contact_t" name="equipments[0][extract_engine_terminal_contact_t]" placeholder="20" type="number">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input class="form-control form-control-sm extract_engine_actual_current" name="equipments[0][extract_engine_actual_current]" placeholder="7.6" type="number" step="0.1">
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm extract_engine_passport_current" name="equipments[0][extract_engine_passport_current]" placeholder="9.2" type="number" step="0.1">
                                                </td>
                                                <td>
                                                <input name="equipments[0][extract_engine_actual_frequency]" id="extract_engine_actual_frequency"
                                                       class="form-control form-control-sm extract_engine_actual_frequency" placeholder="45" type="number">
                                                </td>
                                                <td>
                                                    <input name="equipments[0][extract_engine_passport_frequency]" id="extract_engine_passport_frequency"
                                                           class="form-control form-control-sm extract_engine_passport_frequency" placeholder="50" type="number">
                                                </td>
                                                <td>
                                                    <input name="equipments[0][extract_air_actual_rate]" id="extract_air_actual_rate"
                                                           class="form-control form-control-sm extract_air_actual_rate" placeholder="800" type="number">
                                                </td>
                                                <td>
                                                    <input name="equipments[0][extract_air_passport_rate]" id="extract_air_passport_rate"
                                                           class="form-control form-control-sm extract_air_passport_rate" placeholder="1000" type="number">
                                                </td>
                                                <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>T_extract - температура притока</p>
        ...
        <script src="{{asset('assets/js/checklists/air_extract/add_equipment.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/air_extract/delete_equipment.js')}}" defer></script>
