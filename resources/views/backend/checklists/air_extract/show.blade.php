...
@section('title', 'Главная | Чеклист вытяжки')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Чеклист вытяжки</h4><a href="{{route('checklists_air_extract.create')}}"><img
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-4">
                                    ...
                                    <li class="list-group-item">
                                        <b>Т воздуха вытяжки: </b>{{$checklist->extract_air_t ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Т двигателя вытяжки: </b>{{$checklist->extract_engine_t ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Т переднего подшипника: </b>{{$checklist->front_bearing_t ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Т клемм двигателя: </b>{{$checklist->extract_engine_terminal_contact_t ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Т клемм сервисного выключателя: </b>{{$checklist->service_switch_contact_t ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Ток двигателя факт: </b>{{$checklist->extract_engine_actual_current ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Ток двигателя паспорт: </b>{{$checklist->extract_engine_passport_current ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Частота двигателя факт: </b>{{$checklist->extract_engine_actual_frequency ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Частота двигателя паспорт: </b>{{$checklist->extract_engine_passport_frequency ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Расход воздуха факт: </b>{{$checklist->extract_air_actual_rate ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Расход воздуха паспорт: </b>{{$checklist->extract_air_passport_rate ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                ...
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit') || auth()->id() == $checklist->author_id)
                                        <a href="{{route('checklists_air_extract.edit', $checklist->id)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('checklists_air_extract.destroy', $checklist)}}" method="post">
                                            @csrf
                                            @method('delete')
