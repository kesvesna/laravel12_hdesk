...
@section('title', 'Главная | Чеклист кондиционеров создание')
...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Заполнение чеклистов фанкойлов</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_conditioner.store_from_trk_room', $trk_room)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="row row-cols-1">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tr class="equipment-add-tr">
                                                <td>
                                                    <div style="width: 14rem;" class="input-group input-group-sm equipment-add-div">
                                    ...
                                    <td>
                                        <input style="width: 15rem;" class="form-control form-control-sm comment" name="equipments[0][comment]" type="text" placeholder="Любой комментарий">
                                    </td>
                                </tr>
                                            </tbody>
                                        </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>T_air_in температура воздуха на входе в кондиционер</p>
                        <p>T_air_out температура воздуха на выходе из кондиционера</p>
                    </div>
        ...
        <script src="{{asset('assets/js/checklists/conditioner/add_equipment.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/conditioner/delete_equipment.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/conditioner/add_executor.js')}}"></script>
        <script src="{{asset('assets/js/checklists/conditioner/delete_executor.js')}}"></script>
