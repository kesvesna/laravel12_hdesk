        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Редактирование чеклиста фанкойла</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_fancoil.update', $checklist)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
...
{{--                                    </div>--}}
                                    ...
                                    <div class="equipment-add-div p-2 my-3 rounded"
                                        ...
                                        <div class="row row-cols-1 row-cols-md-5">
                                            ...
                                            <div class="col mb-3">
                                                <label class="form-label form-label-sm" for="equipment_id">Фанкойл
