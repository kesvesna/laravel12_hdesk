            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Чеклист фанкойла</h4><a href="{{route('checklists_fancoil.create')}}"><img
                            ...
                            <div class="card shadow p-3">
                                ...
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit') || auth()->id() == $checklist->author_id)
                                        <a href="{{route('checklists_fancoil.edit', $checklist->id)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('checklists_fancoil.destroy', $checklist)}}" method="post">
                                            @csrf
                                            @method('delete')
