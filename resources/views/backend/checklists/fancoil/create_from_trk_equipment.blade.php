        ...
        <div class="container-fluid">
            ...
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_fancoil.store_from_trk_equipment', $trk_equipment)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
...
{{--                                    </div>--}}
        ...
        <script src="{{asset('assets/js/checklists_fancoil/add_equipment.js')}}"></script>
        <script src="{{asset('assets/js/checklists_fancoil/delete_equipment.js')}}"></script>
        <script src="{{asset('assets/js/checklists_fancoil/add_executor.js')}}"></script>
        <script src="{{asset('assets/js/checklists_fancoil/delete_executor.js')}}"></script>
