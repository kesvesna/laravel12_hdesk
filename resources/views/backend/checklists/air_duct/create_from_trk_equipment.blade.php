...
@section('title', 'Главная | Чеклист воздуховода создание')
...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{$trk_equipment->equipment_name->name . ' - '}} заполнение чеклиста воздуховодов</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_air_duct.store_from_trk_equipment', $trk_equipment)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table class="table table-striped table-sm table-bordered" id="equipment_table">
                                                ...
                                                <tr class="equipment-add-tr">
                                                    ...
                                                    <td>
                                                        <input required class="form-control form-control-sm duct_cross_sectional_area" name="equipments[0][duct_cross_sectional_area]" type="number" step="0.1" placeholder="0.08" min="0" max="10.0">
                                                    </td>
                                                    <td>
        ...
        <script src="{{asset('assets/js/checklists/air_duct/add_equipment.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/air_duct/delete_equipment.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/air_duct/add_executor.js')}}"></script>
        <script src="{{asset('assets/js/checklists/air_duct/delete_executor.js')}}"></script>
