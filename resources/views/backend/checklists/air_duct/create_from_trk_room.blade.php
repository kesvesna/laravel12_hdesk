        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"> {{$trk_room->room->name . ' - '}} заполнение чеклиста воздуховодов</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_air_duct.store_from_trk_room', $trk_room)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-5">
                                        ...
                                        <div class="col-12 col-md-2 mb-3">
                                            ...
                                            <input readonly disabled value="{{$system->name}}"
                                                   class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="row row-cols-1">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tr class="equipment-add-tr">
                                                ...
                                                <td>
                                                    <input required class="form-control form-control-sm duct_cross_sectional_area" name="equipments[0][duct_cross_sectional_area]" type="number" step="0.1" placeholder="0.08">
                                                </td>
                                                <td>
