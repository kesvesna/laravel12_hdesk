            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Чеклист воздуховода</h4><a href="{{route('checklists_air_duct.create')}}"><img
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-4">
                                    ...
                                    <li class="list-group-item">
                                        <b>Оборудование источник: </b><a href="{{route('trk_equipments.show', $checklist->trk_equipment->id)}}">{{$checklist->trk_equipment->equipment_name->name ?? 'не выбрано'}}</a>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item">
                                        <b>Площадь воздуховода, кв.м: </b>{{$checklist->duct_cross_sectional_area ?? 'не выбрано'}}
                                    </li>
                                    <li class="list-group-item">
                                ...
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit') || auth()->id() == $checklist->author_id)
                                        <a href="{{route('checklists_air_duct.edit', $checklist->id)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('checklists_air_duct.destroy', $checklist)}}" method="post">
                                            @csrf
                                            @method('delete')
