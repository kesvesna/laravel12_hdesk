...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Заполнение чеклистов балок</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_balk.store_from_trk_room', $trk_room)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-3 mb-3">
                                            <label for="date" class="form-label form-label-sm">Дата:
                                    ...
                                    <div class="row row-cols-1">
                                        ...
                                        @enderror
                                                ...
                                                <td>
                                                    <input required class="form-control form-control-sm balk_size_type" name="equipments[0][balk_size_type]" type="number" placeholder="300">
                                                </td>
                                                <td>
                                                    <input style="width: 3rem;" class="form-control form-control-sm air_speed" name="equipments[0][air_speed]" type="number" step="0.1" placeholder="3.2">
                                                </td>
                                                <td>
                                                    <input style="width: 3rem;" class="form-control form-control-sm air_flow_rate" name="equipments[0][air_flow_rate]" type="number" placeholder="100">
                                                </td>
                                                <td>
                                                    <input style="width: 3rem;" class="form-control form-control-sm air_pressure" name="equipments[0][air_pressure]" type="number" placeholder="25.5">
                                                </td>
                                    <td>
                                    ...
                                    <td>
                                        <input required class="form-control form-control-sm air_outlet_temperature" name="equipments[0][air_outlet_temperature]" type="number" step="0.1" placeholder="16.2">
                                                ...
                                                <td>
                                                    <input class="form-control form-control-sm air_flap" name="equipments[0][air_flap]" type="text" placeholder="24/24">
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm cold_water_inlet_temperature" name="equipments[0][cold_water_inlet_temperature]" type="number" step="0.1" placeholder="7.0">
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm cold_water_outlet_temperature" name="equipments[0][cold_water_outlet_temperature]" type="number" step="0.1" placeholder="14.5">
                                                </td>
                                                <td>
                                                    <input class="form-control form-control-sm cold_water_pressure_drop" name="equipments[0][cold_water_pressure_drop]" placeholder="1.1" type="number" step="0.1">
                                                </td>
                                                <td>
                                                <input name="equipments[0][cold_water_valve]" id="cold_water_valve"
                                                       class="form-control form-control-sm cold_water_valve" placeholder="10.1" type="number" step="0.1">
                                                </td>
                                                <td>
                                                    <input name="equipments[0][cold_water_rate]" id="cold_water_rate"
                                                           class="form-control form-control-sm cold_water_rate" placeholder="5.6" type="number" step="0.1">
                                                </td>
                                                <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>P_delta_water перепад давления воды</p>
                        <p>Water_valve на сколько открыт клапан воды</p>
                        <p>Q_water расход воды</p>
                    </div>
        ...
        <script src="{{asset('assets/js/checklists/balk/add_equipment.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/balk/delete_equipment.js')}}" defer></script>
