        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Редактирование чеклиста балки</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_balk.update', $checklist)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
...
{{--                                    </div>--}}
                                    ...
                                    <div class="equipment-add-div p-2 my-3 rounded"
                                        ...
                                        <div class="row row-cols-1 row-cols-md-5">
                                            ...
                                            <div class="col mb-3">
                                                <label class="form-label form-label-sm" for="equipment_id">Балка
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input required name="balk_size_type" id="balk_size_type"
                                                           class="form-control form-control-sm" placeholder="300" type="number" value="{{old('balk_size_type', $checklist->balk_size_type)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="air_speed" id="air_speed"
                                                           class="form-control form-control-sm" placeholder="3.6" type="number" step="0.1" value="{{old('air_speed', $checklist->air_speed)}}">
                                                    @error('air_speed')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="air_flow_rate" id="air_flow_rate"
                                                           class="form-control form-control-sm" placeholder="85.0" type="number" step="0.1" value="{{old('air_flow_rate', $checklist->air_flow_rate)}}">
                                                    @error('air_flow_rate')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="air_pressure" id="air_pressure"
                                                           class="form-control form-control-sm" placeholder="23.0" type="number" step="0.1" value="{{old('air_pressure', $checklist->air_pressure)}}">
                                                    @error('air_pressure')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <input required name="air_inlet_temperature" id="air_inlet_temperature"
                                                           class="form-control form-control-sm" placeholder="22.6" type="number" step="0.1" value="{{old('air_inlet_temperature', $checklist->air_inlet_temperature)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <input required name="air_outlet_temperature" id="air_outlet_temperature"
                                                           class="form-control form-control-sm" placeholder="16.3" type="number" step="0.1" value="{{old('air_outlet_temperature', $checklist->air_outlet_temperature)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="air_flap" id="air_flap"
                                                           class="form-control form-control-sm" placeholder="24/24" type="text" value="{{old('air_flap', $checklist->air_flap)}}">
                                                    @error('air_flap')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="cold_water_inlet_temperature" id="cold_water_inlet_temperature"
                                                           class="form-control form-control-sm" placeholder="7.6" type="number" step="0.1" value="{{old('cold_water_inlet_temperature', $checklist->cold_water_inlet_temperature)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="cold_water_outlet_temperature" id="cold_water_outlet_temperature"
                                                           class="form-control form-control-sm" placeholder="14.3" type="number" step="0.1" value="{{old('cold_water_outlet_temperature', $checklist->cold_water_outlet_temperature)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="cold_water_pressure_drop" id="cold_water_pressure_drop"
                                                           class="form-control form-control-sm" placeholder="1.1" type="number" step="0.1" value="{{old('cold_water_pressure_drop', $checklist->cold_water_pressure_drop)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="cold_water_valve" id="cold_water_valve"
                                                           class="form-control form-control-sm" placeholder="10.1" type="number" step="0.1" value="{{old('cold_water_valve', $checklist->cold_water_valve)}}">
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input name="cold_water_rate" id="cold_water_rate"
                                                           class="form-control form-control-sm" placeholder="5.6" type="number" step="0.1" value="{{old('cold_water_rate', $checklist->cold_water_rate)}}">
