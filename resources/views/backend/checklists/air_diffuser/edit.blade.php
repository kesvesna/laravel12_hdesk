        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Чеклист диффузора редактирование</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_air_diffuser.update', $checklist)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
...
{{--                                    </div>--}}
                                    ...
                                    <div class="equipments-add-parent-div mb-3">
                                        <div class="equipment-add-div p-2 my-3 rounded"
                                            ...
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    <label for="estimated_coefficient" class="form-label form-label-sm">Коэффициент для расчета
                                                    </label>
                                                    <input name="estimated_coefficient" id="estimated_coefficient"
                                                           class="form-control form-control-sm"  type="number" step="0.1" placeholder="0.8" value="{{old('estimated_coefficient', $checklist->estimated_coefficient)}}">
                                                    @error('estimated_coefficient')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="row row-cols-1 mb-3">
                                                <div class="col-12 col-md-3">
                                                    <label for="diffuser_cross_sectional_area" class="form-label form-label-sm">Площадь сечения воздуховода, кв.м
                                                        <span class="text-danger"><b>*</b></span>
                                                    </label>
                                                    <input required name="diffuser_cross_sectional_area" id="diffuser_cross_sectional_area"
                                                           class="form-control form-control-sm"  type="number" step="0.1" placeholder="0.08" value="{{old('diffuser_cross_sectional_area', $checklist->diffuser_cross_sectional_area)}}">
                                                    @error('diffuser_cross_sectional_area')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            </div>
