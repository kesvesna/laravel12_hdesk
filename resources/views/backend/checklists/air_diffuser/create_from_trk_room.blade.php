        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"> {{$trk_room->room->name . ' - '}} заполнение чеклиста диффузоров</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('checklists_air_diffuser.store_from_trk_room', $trk_room)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                        ...
                                        <div class="row row-cols-1 row-cols-md-5">
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <input required type="text" list="equipment_names_list"
                                                       ...
                                                       name="equipment_id" data-equipment-id="0" id="equipment_id">
...
{{--        <script src="{{asset('assets/js/checklists/air_diffuser/add_equipment.js')}}" defer></script>--}}
        ...
        <script src="{{asset('assets/js/checklists/air_diffuser/add_executor.js')}}" defer></script>
        <script src="{{asset('assets/js/checklists/air_diffuser/delete_executor.js')}}" defer></script>
@endsection
