...
@section('title', 'Просмотр | Решение комиссии')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Решение комиссии</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item"><b>Название: </b>{{$resume_name->name}}</li>
                                </ul>
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit'))
                                        <a href="{{route('resume_names.edit', $resume_name)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('resume_names.destroy', $resume_name)}}" method="post">
                                            @csrf
                                            @method('delete')
