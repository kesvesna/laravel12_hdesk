...
@section('title', 'Название оборудования | Редактирование')
        ...
        <div class="container-fluid">
            ...
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('equipment_names.update', $equipment_name)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
                                ...
                                <div class="card shadow">
                                    <div class="input-group mt-3 px-3">
                                        ...
                                        <input value="{{$equipment_name->name}}" name="name" type="text"
                                    ...
                                    <div class="input-group my-3 px-3">
                                        ...
                                        <input value="{{$equipment_name->alias}}" name="alias" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$equipment_name->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$equipment_name->author->name}}" name="author_id" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$equipment_name->updated_at}}" name="updated_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$equipment_name->last_editor->name}}" name="last_editor_id"
