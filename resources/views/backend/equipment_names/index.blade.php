...
@section('title', 'Главная | Названия оборудования')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Названия оборудования</h4>
                        @if(auth()->user()->can('create'))
                            <a href="{{route('equipment_names.create')}}"><img
                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    <table class="table table-striped table-hover shadow">
                                        ...
                                        <tr>
                                            <td>
                                                <form action="{{route('equipment_names.index')}}" method="get">
                                                    @csrf
                                        ...
                                        @forelse($equipment_names as $equipment_name)
                                            @if(auth()->user()->can('read'))
                                                <tr onclick="window.location='{{ route('equipment_names.show', $equipment_name->id) }}';">
                                            @else
                                                <tr>
                                                    @endif
                                    ...
                                    {{$equipment_names->withQueryString()->links()}}
                                </div>
                            </div>
                        </div>
                    </div>
