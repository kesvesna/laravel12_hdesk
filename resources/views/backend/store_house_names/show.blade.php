...
@section('title', 'Просмотр | Название склада')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Название склада</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item"><b>Название: </b>{{$store_house_name->name}}</li>
                                </ul>
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit'))
                                        <a href="{{route('store_house_names.edit', $store_house_name)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('store_house_names.destroy', $store_house_name)}}"
                                              method="post">
                                            @csrf
                                            @method('delete')
