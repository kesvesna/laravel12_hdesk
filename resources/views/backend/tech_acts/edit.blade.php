...
@section('title', 'Главная | Технические акты редактирование')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Технические акты редактирование</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('tech_acts.update', $tech_act)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    <div class="row">
                                        <div class="col mb-3">
                                            ...
                                            <input required type="date" name="write_at"
                                                   ...
                                                   value="{{old('write_at', $tech_act->write_at)}}">
                                            @error('write_at')
                                    ...
                                    <div class="row">
                                        <div class="col mt-4">
                                            ...
                                            <input required type="date" name="inspection_at"
                                                   class="form-control form-control-sm"
                                                   value="{{old('inspection_at', $tech_act->inspection_at)}}">
                                            @error('inspection_at')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col mt-3">
                                            ...
                                            <input required type="text" name="room_name"
                                                   class="form-control form-control-sm"
                                                   value="{{old('room_name', $tech_act->room_name)}}">
                                            @error('room_name')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col mt-3">
                                            ...
                                            <input required type="text" name="equipment_name"
                                                   class="form-control form-control-sm"
                                                   value="{{old('equipment_name', $tech_act->equipment_name)}}">
                                    ...
                                    <div class="row">
                                        <div class="col mt-3">
                                            ...
                                            <textarea required name="trouble_description"
                                                      class="form-control form-control-sm">{{old('trouble_description', $tech_act->trouble_description)}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col mt-3">
                                            ...
                                            <textarea required name="reason_description" rows="2"
                                                      class="form-control form-control-sm">{{old('reason_description', $tech_act->reason_description)}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col mt-3">
                                            ...
                                            <textarea required name="recovery_method_description" rows="2"
                                                      class="form-control form-control-sm">{{old('recovery_method_description', $tech_act->recovery_method_description)}}</textarea>
                                            @error('recovery_method_description')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="tech-act-spare-parts-add-parent-div mt-4">
                                                    ...
                                                    <div class="col-12 col-md-10">
                                                        ...
                                                        <span
                                                            ...
                                                            <input required type="text"
                                                                   ...
                                                                   name="spare_parts[]"
                                                                   value="{{$spare_part->spare_part_name}}">
                                                        </div>
                                                        @error('spare_parts.*')
                                                        <div class="text-danger"
                                                             style="margin-top: -1rem !important;">{{$message}}</div>
                                    ...
                                    <div class="input-group mt-4 input-group-sm">
                                        <a href="{{route('tech_acts.show', $tech_act)}}"
