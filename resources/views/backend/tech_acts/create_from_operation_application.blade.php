...
@section('title', 'Главная | Технический акт по заявке')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Технический акт по заявке</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('tech_acts.store_from_operation_application', $operation_application)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
