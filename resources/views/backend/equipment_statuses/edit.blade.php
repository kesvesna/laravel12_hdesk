...
@section('title', 'Статус оборудования | Редактирование')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Редактирование статуса</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('equipment_statuses.update', $equipment_status)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$equipment_status->name}}" name="name" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$equipment_status->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$equipment_status->author->name}}" name="author_id" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$equipment_status->updated_at}}" name="updated_at" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$equipment_status->last_editor->name}}" name="last_editor_id"
                                               type="text" class="form-control form-control-sm" placeholder="Редактор"
                                               aria-label="alias" aria-describedby="basic-addon1" readonly>
                                    </div>
                                    <div class="input-group mb-3 input-group-sm">
                                        <a href="{{route('equipment_statuses.show', $equipment_status)}}"
