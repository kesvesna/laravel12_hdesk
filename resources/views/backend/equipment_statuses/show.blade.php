...
@section('title', 'Просмотр | Статус оборудования')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Статус оборудования</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item"><b>Название: </b>{{$equipment_status->name}}</li>
                                </ul>
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit'))
                                        <a href="{{route('equipment_statuses.edit', $equipment_status)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('equipment_statuses.destroy', $equipment_status)}}"
                                              method="post">
                                            @csrf
                                            @method('delete')
