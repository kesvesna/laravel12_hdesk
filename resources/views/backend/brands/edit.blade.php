...
@section('title', 'Главная | Бренд редактирование')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Бренд редактирование</h4>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{route('brands.update', $brand)}}" method="post">
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="input-group my-3 px-3">
                                        ...
                                        <input value="{{$brand->alias}}" name="alias" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$brand->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$brand->author->name}}" name="author_id" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$brand->updated_at}}" name="updated_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$brand->last_editor->name}}" name="last_editor_id" type="text"
