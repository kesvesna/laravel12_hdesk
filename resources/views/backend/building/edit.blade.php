...
@section('title', 'Главная | Блок/Зона редактирование')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Блок/Зона редактирование</h4>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{route('building.update', $building)}}" method="post">
                                ...
                                <div class="card shadow">
                                    <div class="input-group mt-3 px-3">
                                        ...
                                        <input value="{{$building->name}}" name="name" type="text"
                                    ...
                                    <div class="input-group my-3 px-3">
                                        ...
                                        <input value="{{$building->alias}}" name="alias" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$building->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$building->author->name}}" name="author_id" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$building->updated_at}}" name="updated_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$building->last_editor->name}}" name="last_editor_id"
