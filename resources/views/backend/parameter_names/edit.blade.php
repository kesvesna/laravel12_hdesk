        ...
        <div class="container-fluid">
            ...
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('parameter_names.update', $parameter_name)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$parameter_name->name}}" name="name" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$parameter_name->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$parameter_name->author->name}}" name="author_id" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$parameter_name->updated_at}}" name="updated_at" type="text"
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input value="{{$parameter_name->last_editor->name}}" name="last_editor_id"
                                               type="text" class="form-control form-control-sm" placeholder="Редактор"
                                               aria-label="alias" aria-describedby="basic-addon1" readonly>
                                    </div>
                                    <div class="input-group mb-3 input-group-sm">
                                        <a href="{{route('parameter_names.show', $parameter_name)}}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel2">Создание параметра</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Не создавайте смешанных названий, кириллица/латиница</p>
