            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Поздраделение/Должность</h4><a
                            href="{{route('user_division_functions.create')}}"><img
                            ...
                            <div class="card shadow p-3">
                                <ul class="list-group mb-4">
                                    <li class="list-group-item">
                                        <b>Подразделение: </b>{{$user_division_function->division->name}}
                                    </li>
                                    <li class="list-group-item">
                                        <b>Должность: </b>{{$user_division_function->function->name}}</li>
                                </ul>
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit'))
                                        <a href="{{route('user_division_functions.edit', $user_division_function)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('user_division_functions.destroy', $user_division_function)}}"
                                              method="post">
                                            @csrf
                                            @method('delete')
