...
@section('title', 'Главная | Организации')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Организации</h4>
                        @if(auth()->user()->can('create'))
                            <a href="{{route('organization.create')}}"><img
                                    ...
                                    <table class="table table-striped table-hover shadow">
                                        ...
                                        @forelse($organizations as $organization)
                                            @if(auth()->user()->can('read'))
                                                <tr onclick="window.location='{{ route('organization.show', $organization->id) }}';">
                                            @else
                                                <tr>
                                                    @endif
