...
@section('title', 'Главная | Организация редактирование')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Организация редактирование</h4>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card shadow p-3">
                                    <div class="row">
                                        <div class="col mb-3">
                                            ...
                                            <input name="name" id="name" required class="form-control form-control-sm"
