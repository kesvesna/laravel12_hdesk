...
@section('title', 'Главная | Отчет по заявкам ТРК')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="d-inline-block me-3">Отчет по заявкам ТРК</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <form action="{{route('trk_reports.operation_application.report')}}" method="post">
                                                @csrf
                                                @method('post')
