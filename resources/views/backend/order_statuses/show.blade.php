...
@section('title', 'Просмотр | Статус заказа')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Статус заказа</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item"><b>Название: </b>{{$order_status->name}}</li>
                                </ul>
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit'))
                                        <a href="{{route('order_statuses.edit', $order_status)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('order_statuses.destroy', $order_status)}}" method="post">
                                            @csrf
                                            @method('delete')
