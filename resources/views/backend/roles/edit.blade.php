...
@section('title', 'Главная | Роль редактирование')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Роль редактирование</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <form action="{{route('roles.update', $role)}}" method="post">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label class="form-label form-label-sm">Права:</label>
                                            <select class="from-select form-select-sm col-12 h-100" multiple name="permissions[]">
                                                @forelse($permissions as $permission)
                                                    <option value="{{$permission->name}}" {{$role->hasPermissionTo($permission->name) ? 'selected' : null}}>{{$permission->name}}</option>
                                                @empty
                                    ...
                                    <div class="input-group input-group-sm mb-3 mt-5">
                                        ...
                                        <input value="{{$role->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input value="{{$role->updated_at}}" name="updated_at" type="text"
