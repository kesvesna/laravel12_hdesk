                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item mb-3"><b>Название: </b>{{$role->name}}</li>
                                    <ul class="list-group mb-3">
                                        <label class="form-label form-label-sm"><b>Права: </b></label>
