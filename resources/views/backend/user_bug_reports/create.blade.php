...
@section('title', 'Главная | Описание бага')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Описание бага</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('user_bug_reports.store')}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            ...
                                            <textarea required name="trouble_description"
                                                      ...
                                                      placeholder="Описание проблемы, как она получилась, что нужно сделать чтобы увидеть эту проблему">{{old('trouble_description')}}</textarea>
