...
@section('title', 'Главная | Создание лога заявки в эксплуатацию')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Создание лога заявки в эксплуатацию</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('operation_applications_log.store')}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
