...
@section('title', 'Запчасти оборудования | Создание')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Запчасть оборудования новая</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('equipment_spare_parts.store')}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                ...
                                <div class="card shadow p-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <a href="{{route('equipment_spare_parts.index')}}"
