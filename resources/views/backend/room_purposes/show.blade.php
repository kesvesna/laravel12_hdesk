...
@section('title', 'Просмотр | Назначение помещения')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Назначение помещения</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card shadow p-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item"><b>Название: </b>{{$room_purpose->name}}</li>
                                </ul>
                                <div class="btn-group btn-group-sm col-12 col-md-6" role="group"
                                    ...
                                    @if(auth()->user()->can('edit'))
                                        <a href="{{route('room_purposes.edit', $room_purpose)}}"
                                    ...
                                    @if(auth()->user()->can('delete'))
                                        <form action="{{route('room_purposes.destroy', $room_purpose)}}" method="post">
                                            @csrf
                                            @method('delete')
