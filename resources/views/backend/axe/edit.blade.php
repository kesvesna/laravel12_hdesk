...
@section('title', 'Главная | Ось редактирование')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Ось редактирование</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('axe.update', $axe)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="col">
                                ...
                                <div class="card shadow">
                                    <div class="input-group  input-group-sm mt-3 px-3">
                                        ...
                                        <input value="{{$axe->name}}" name="name" type="text"
                                    ...
                                    @enderror
                                    <div class="input-group input-group-sm  mb-3 px-3 mt-3">
                                        <span class="input-group-text input-group-sm col-6 col-md-2"
                                              id="basic-addon1"><b>Создан:</b></span>
                                        <input value="{{$axe->created_at . ', ' . $axe->author->name}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group input-group-sm mb-3 px-3">
                                        ...
                                        <input value="{{$axe->updated_at . ', ' . $axe->last_editor->name}}" name="updated_at" type="text"
                                               class="form-control form-control-sm" placeholder="Исправлен"
                                               aria-label="alias" aria-describedby="basic-addon1" readonly>
                                    </div>
                                    <div class="input-group input-group-sm mb-3 px-3">
                                        <a href="{{route('axe.show', $axe)}}"
