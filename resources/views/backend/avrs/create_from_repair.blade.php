...
@section('title', 'Главная | АВР создание по ремонту')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">АВР создание по ремонту</h4>
                    </div>
                </div>
            </div>
            <div class="profile-foreground position-relative"
                ...
                <div class="pt-4 mb-lg-3 pb-lg-4 px-4">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('avrs.store_from_repair', $repair)}}" method="post">
                                @csrf
                                @method('post')
                                <div class="col">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-4">
                                        <div class="col mb-3">
                                            ...
                                            <select disabled name="trk_id" class="form-select form-select-sm"
                                                    id="trk_id">
                                                    <option value="{{$repair->trk_room->trk->id}}">{{$repair->trk_room->trk->name}}</option>
                                            </select>
                                            @error('trk_id')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        ...
                                        <div class="col mb-3">
                                            <label for="building_id" class="form-label form-label-sm">Блок/Зона <span
                                                    class="text-danger"><b>*</b></span></label>
                                            <select disabled name="building_id" class="form-select form-select-sm"
                                                    id="building_id">
                                                <option value="{{$repair->trk_room->building->id}}">{{$repair->trk_room->building->name}}</option>
                                            </select>
                                            @error('building_id')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        ...
                                        <div class="col mb-3">
                                            <label for="floor_id" class="form-label form-label-sm">Этаж <span
                                                    class="text-danger"><b>*</b></span></label>
                                            <select disabled name="floor_id" class="form-select form-select-sm"
                                                    id="floor_id">
                                                <option value="{{$repair->trk_room->floor->id}}">{{$repair->trk_room->floor->name}}</option>
                                            </select>
                                            @error('floor_id')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                        ...
                                        <div class="col mb-4">
                                            <label for="room_id" class="form-label form-label-sm">Помещение <span
                                                    class="text-danger"><b>*</b></span></label>
                                            <select disabled name="room_id" class="form-select form-select-sm"
                                                    id="room_id">
                                                <option value="{{$repair->trk_room->room->id}}">{{$repair->trk_room->room->name}}</option>
                                            </select>
                                            @error('room_id')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col col-md-3 mb-3">
                                            <label for="system_id" class="form-label form-label-sm">Система <span
                                                    class="text-danger"><b>*</b></span></label>
                                            <select disabled name="system_id" class="form-select form-select-sm">
                                                <option value="{{$repair->trk_equipment->system->id}}">{{$repair->trk_equipment->system->name}}</option>
                                            </select>
                                            @error('system_id')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
...
{{--                                                               list="equipment_names_list"--}}
                                                               class="form-control form-control-sm equipment-name-input"
                                                               placeholder="Начните писать ..."
                                                               name="equipment_name" data-equipment-id="0" value="{{$repair->trk_equipment->equipment_name->name}}">
