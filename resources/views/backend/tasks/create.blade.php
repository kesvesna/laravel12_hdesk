...
@section('title', 'Главная | Создание задачи')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Создание задачи</h4>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select class="form-select form-select-sm" name="responsible_id"
                                                ...
                                                @forelse($responsibles as $responsible)
                                                    <option
                                                        value="{{$responsible->id}}" {{Auth::id() == $responsible->id ? 'selected' : null}}>{{$responsible->name}}</option>
                                                @empty
                                                    <option value="">нет данных ...</option>
                                                @endforelse
                                            </select>
