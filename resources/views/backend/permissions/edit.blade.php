...
@section('title', 'Главная | Права редактирование')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Права редактирование</h4>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{route('permissions.update', $permission)}}" method="post">
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$permission->created_at}}" name="created_at" type="text"
                                    ...
                                    <div class="input-group mb-3 px-3">
                                        ...
                                        <input value="{{$permission->updated_at}}" name="updated_at" type="text"
